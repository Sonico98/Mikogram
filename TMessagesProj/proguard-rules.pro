...
-keepclassmembernames,allowshrinking class dev.axllr8tr.mikogram.MessageDetailsActivity$TextDetailSimpleCell { <fields>; }
-keepclassmembernames,allowshrinking class dev.axllr8tr.mikogram.settings.AccountCell { <fields>; }
-keepclassmembernames,allowshrinking class dev.axllr8tr.mikogram.settings.EmojiSetCell { <fields>; }
-keepclassmembernames,allowshrinking class dev.axllr8tr.mikogram.settings.NekoChatSettingsActivity$StickerSizeCell { <fields>; }
