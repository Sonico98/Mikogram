...
1. Go to https://console.firebase.google.com/, create two android apps with application IDs dev.axllr8tr.mikogram and dev.axllr8tr.mikogram.beta, turn on firebase messaging and download `google-services.json`, which should be copied into `TMessagesProj` folder.
